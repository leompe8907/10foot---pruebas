    ...
    $.extend(true, AppData, Events, {
        ...
        getVOD: function(callback) {
            ...
            cv.getVOD(function (library) {
                ...
                self.vodCategories.sort(function (a, b) {
                ...
                cv.getVODContent(function (vods) {
                    callback(self.prepareDataForVOD(vods));
                }, function() {
                    callback(self.vodCategories);
                });
            }, function() {
                callback([]);
            });
        ...
        getEPGByBouquet: function(callback, index) {
            ...
            cv.getEPG(url, function(data) { 
                ...
                console.log("ERROR load EPG (" + index + ")" + error);
